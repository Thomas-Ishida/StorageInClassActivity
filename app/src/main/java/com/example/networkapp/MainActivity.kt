...
//private const val SAVED_COMIC_FILENAME = "saved_comic.json"
class MainActivity : AppCompatActivity() {
    ...
    private var currentComicObject: JSONObject? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(file.exists()) {
            try {
                ...
                br.close()
                val lastComic = JSONObject(text.toString())
                showComic(lastComic)
            } catch (e: IOException) {
                e.printStackTrace()
            }
    ...
    private fun showComic (comicObject: JSONObject) {
        this.currentComicObject = comicObject
